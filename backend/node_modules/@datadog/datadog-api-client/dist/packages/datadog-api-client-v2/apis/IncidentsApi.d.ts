...
export declare class IncidentsApiRequestFactory extends BaseAPIRequestFactory {
    ...
    deleteIncidentAttachment(incidentId: string, attachmentId: any, _options?: Configuration): Promise<RequestContext>;
    ...
    updateIncidentAttachment(incidentId: string, attachmentId: any, body: PatchAttachmentRequest, include?: string, _options?: Configuration): Promise<RequestContext>;
