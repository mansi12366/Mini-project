...
class SecurityMonitoringApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    attachJiraIssue(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'attachJiraIssue'");
    ...
    cancelThreatHuntingJob(jobId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'cancelThreatHuntingJob'");
            if (!_config.unstableOperations["v2.cancelThreatHuntingJob"]) {
                throw new Error("Unstable operation 'cancelThreatHuntingJob' is disabled");
            }
            // verify required parameter 'jobId' is not null or undefined
            if (jobId === null || jobId === undefined) {
                throw new baseapi_1.RequiredError("jobId", "cancelThreatHuntingJob");
            }
            // Path Params
            const localVarPath = "/api/v2/siem-threat-hunting/jobs/{job_id}/cancel".replace("{job_id}", encodeURIComponent(String(jobId)));
            // Make Request Context
            const requestContext = _config
    ...
    createJiraIssues(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'createJiraIssues'");
    ...
    deleteThreatHuntingJob(jobId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'deleteThreatHuntingJob'");
            if (!_config.unstableOperations["v2.deleteThreatHuntingJob"]) {
                throw new Error("Unstable operation 'deleteThreatHuntingJob' is disabled");
            }
            // verify required parameter 'jobId' is not null or undefined
            if (jobId === null || jobId === undefined) {
    ...
    getSecurityMonitoringHistsignal(histsignalId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Path Params
            const localVarPath = "/api/v2/siem-threat-hunting/histsignals/{histsignal_id}".replace("{histsignal_id}", encodeURIComponent(String(histsignalId)));
            // Make Request Context
            const requestContext = _config
    ...
    getSecurityMonitoringHistsignalsByJobId(jobId, filterQuery, filterFrom, filterTo, sort, pageCursor, pageLimit, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Path Params
            const localVarPath = "/api/v2/siem-threat-hunting/jobs/{job_id}/histsignals".replace("{job_id}", encodeURIComponent(String(jobId)));
            // Make Request Context
            const requestContext = _config
    ...
    listAssetsSBOMs(pageToken, pageNumber, filterAssetType, filterAssetName, filterPackageName, filterPackageVersion, filterLicenseName, filterLicenseType, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'listAssetsSBOMs'");
    ...
    listSecurityMonitoringCriticalAssets(query, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // Path Params
            const localVarPath = "/api/v2/security_monitoring/configuration/critical_assets";
    ...
    listSecurityMonitoringRules(pageSize, pageNumber, query, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // Path Params
            const localVarPath = "/api/v2/security_monitoring/rules";
    ...
    listSecurityMonitoringSuppressions(query, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // Path Params
            const localVarPath = "/api/v2/security_monitoring/configuration/suppressions";
    ...
    runThreatHuntingJob(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'runThreatHuntingJob'");
            if (!_config.unstableOperations["v2.runThreatHuntingJob"]) {
                throw new Error("Unstable operation 'runThreatHuntingJob' is disabled");
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "runThreatHuntingJob");
            }
            // Path Params
            const localVarPath = "/api/v2/siem-threat-hunting/jobs";
            // Make Request Context
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "RunThreatHuntingJobRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
...
class SecurityMonitoringApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    cancelThreatHuntingJob(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    deleteThreatHuntingJob(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 204) {
                return;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getThreatHuntingJob(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ThreatHuntingJobResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 403 ||
...
class SecurityMonitoringApi {
     ...
     * @param param The request object
     */
    cancelThreatHuntingJob(param, options) {
        const requestContextPromise = this.requestFactory.cancelThreatHuntingJob(param.jobId, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
     ...
     * @param param The request object
     */
    deleteThreatHuntingJob(param, options) {
        const requestContextPromise = this.requestFactory.deleteThreatHuntingJob(param.jobId, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
     ...
     * @param param The request object
     */
    listSecurityMonitoringCriticalAssets(param = {}, options) {
        const requestContextPromise = this.requestFactory.listSecurityMonitoringCriticalAssets(param.query, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
    ...
    listSecurityMonitoringRules(param = {}, options) {
        const requestContextPromise = this.requestFactory.listSecurityMonitoringRules(param.pageSize, param.pageNumber, param.query, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
    ...
    listSecurityMonitoringSuppressions(param = {}, options) {
        const requestContextPromise = this.requestFactory.listSecurityMonitoringSuppressions(param.query, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
     ...
     * @param param The request object
     */
    runThreatHuntingJob(param, options) {
        const requestContextPromise = this.requestFactory.runThreatHuntingJob(param.body, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
